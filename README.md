...
4. Set the `min_timestamp` variable to the start date of your choosing. (The script only imports listens after the set timestamp. Defaults to year 2000 (keeps everything), use [epochconverter.com](https://www.epochconverter.com/) to get a timestamp for a specific cutoff date.)
